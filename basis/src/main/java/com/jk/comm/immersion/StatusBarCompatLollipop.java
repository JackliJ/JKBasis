...
class StatusBarCompatLollipop {
     ...
     */
    static void setStatusBarColor(Activity activity, int statusColor, boolean isWhite) {
...
//        }
        window.setStatusBarColor(statusColor);
        //SYSTEM_UI_FLAG_LIGHT_STATUS_BAR  设置黑色字体---------SYSTEM_UI_FLAG_VISIBLE白色字体
        window.getDecorView().setSystemUiVisibility(isWhite ? View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR : View.SYSTEM_UI_FLAG_VISIBLE);
    ...
    static void setStatusBarTextColor(Activity activity, boolean isWhite) {
        Window window = activity.getWindow();
        //SYSTEM_UI_FLAG_LIGHT_STATUS_BAR  设置黑色字体---------SYSTEM_UI_FLAG_VISIBLE白色字体
        ...
        //SYSTEM_UI_FLAG_LIGHT_STATUS_BAR  设置黑色字体---------SYSTEM_UI_FLAG_VISIBLE白色字体
//        window.getDecorView().setSystemUiVisibility(isWhite ? View.SYSTEM_UI_FLAG_VISIBLE : View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
    }
